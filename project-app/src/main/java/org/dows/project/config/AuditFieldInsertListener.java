...
//
//                    // 自动填充创建时间字段
//                    if (("createTime".equals(fieldName) || "create_time".equals(fieldName))
//                            && field.getType() == LocalDateTime.class) {
//                        field.set(entity, now);
//                    }
//                    // 自动填充更新时间字段
//                    else if (("updateTime".equals(fieldName) || "update_time".equals(fieldName))
//                            && field.getType() == LocalDateTime.class) {
//                        field.set(entity, now);
//                    }
//                    // 自动填充创建人字段
//                    else if (("createUser".equals(fieldName) || "create_user".equals(fieldName))
//                            && (field.getType() == String.class || field.getType() == Long.class || field.getType() == long.class)) {
//                        field.set(entity, currentUser.getNickname());
//                    }
//                    // 自动填充更新人字段
//                    else if (("updateUser".equals(fieldName) || "update_user".equals(fieldName))
//                            && (field.getType() == String.class || field.getType() == Long.class || field.getType() == long.class)) {
//                        field.set(entity, currentUser.getNickname());
//                    }
